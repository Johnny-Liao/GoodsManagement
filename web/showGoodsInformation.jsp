    ...
    <form id="formresume" method="post">
      <div class="search">
        <table border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td>品名：</td>
            <td><input type="text" name="goodName" value="<s:property value="listGood[0].goodname"/>" class="s_inputs"/></td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td>单位：</td>
            <td><input type="text" name="goodUnit" value="<s:property value="listGood[0].goodunit"/>"  class="s_inputs"/></td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        ...
        <div class="contlist">
          <table border="0" cellspacing="0" cellpadding="0" style="width:100%;">
            ...
            <tr style="color:#000; font-size:14px; padding:10px 0;">
              <s:iterator var="column" value="@org.goodsManagement.ResourceString.Resource@goodNuberAndTypeHead" id="headname">
