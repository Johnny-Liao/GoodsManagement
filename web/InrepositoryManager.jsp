    ...
    <form id="formresume" enctype="multipart/form-data" method="post">
      <div class="search">
        <table border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td><input type="submit"  name="submit" id="button" value="查询"  class="s_btn"  onclick="javascript:this.form.action='/InRepository!selectbysearch?page=1'"/></td>
          </tr>
          <tr>
      ...
      <div  class="tum">
        <div class="contlist">
          ...
          <td><input type="submit"  name="submit" id="up" value="上一页"  class="s_btn"  onclick="javascript:this.form.action='/InRepository!dispachar?page=${(page - 1) > 1 ? (page - 1) : 1}'"/></td>
          共<s:property value="countpage"></s:property>页
          当前第<s:property value="page"></s:property>页
          <td><input type="submit"  name="submit" id="down" value="下一页"  class="s_btn"  onclick="javascript:this.form.action='/InRepository!dispachar?page=${(page + 1) > countpage ? countpage : (page + 1)}'"/></td>
        </div>
