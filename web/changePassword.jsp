        ...
        <table class="tdfont" width="707" height="120" border="1" cellpadding="0" cellspacing="0"
            ...
            <tr align="center">
                <td height="28" colspan="2"><font
                        style="font-weight:bold;">密码更改</font></td>
            </tr>
            <tr>
                <td width="233" height="28" align="right">用户名：</td>
                <td width="523" height="28"><label><input type="text" name="username" value="<s:property value="#session.user.username"/>" readonly="true"/></label></td>
            </tr>
            <tr>
                <td height="28">
            ...
            <tr>
                ...
                <td height="28"><label><input type="password" name="ensure_password"/>*（必填）</label></td>
            </tr>
            <tr>
                <td height="28">&nbsp;</td>
                <td height="28">
                    ...
                    <font color="#FF0000"><s:property value="#session.message"/></font>
                </td>
            </tr>
        </table>
    </form>
